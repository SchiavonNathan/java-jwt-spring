package com.elielentrega.atividade.config;

import com.elielentrega.atividade.service.JwtService;
...
public class SecurityConfig {
    ...
    @Bean
    public JwtAuthentication jwtAuthenticationFilter(UserDetailsService userDetailsService) {
